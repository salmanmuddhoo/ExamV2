...
export function PayPalPayment({
  ...
  return (
    <div className="max-w-2xl mx-auto">
      {/* PayPal Header Banner */}
      <div className="mb-6 bg-gradient-to-r from-blue-600 to-blue-400 rounded-lg p-6 text-white">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-100">Pay safely with your PayPal account</p>
            </div>
          </div>
          {!hideBackButton && (
            <button
