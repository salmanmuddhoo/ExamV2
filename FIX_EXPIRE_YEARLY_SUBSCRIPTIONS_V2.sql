-- ============================================================
-- FIX V2: expire_yearly_subscriptions() Function
-- ============================================================
-- This completely rewrites the function to avoid the ON CONFLICT error
-- by separating the logic into distinct steps
-- ============================================================
...
COMMENT ON FUNCTION expire_yearly_subscriptions IS
  'Expires yearly subscriptions when they reach their subscription_end_date (1 year after purchase) and downgrades to free tier. Uses a loop to process each user individually to avoid ON CONFLICT issues.';
