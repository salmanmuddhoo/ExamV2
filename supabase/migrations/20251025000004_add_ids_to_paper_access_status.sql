...
COMMENT ON FUNCTION get_user_paper_access_status IS 'Returns all papers with their access status for a user. Now includes subject_id and grade_level_id for proper filtering.';
